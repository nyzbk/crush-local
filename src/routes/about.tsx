  ...
  return (
    <AppShell>
      <main className="mx-auto max-w-2xl px-4 py-12">
        <h1 className="font-display text-4xl">About Crush</h1>
        <p className="mt-6 text-pretty">
          Crush is a free, private image compressor. It exists because most “free” compressors upload your photos to a
