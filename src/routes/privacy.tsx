    ...
    <AppShell>
      <main className="mx-auto max-w-2xl px-4 py-12">
        ...
        <p className="mt-4 text-pretty">
          Crush compresses images entirely in your browser with the Canvas API. Photos you drop here are not uploaded to
          our servers for processing. There is no account, no tracking of file contents, and no cloud conversion.
        </p>
        ...
        <ul className="mt-4 list-disc space-y-2 pl-5 text-pretty text-muted">
          <li>
            <strong className="text-ink">Files you select</strong> stay on this device. Compression runs in the tab
            (ImageBitmap + Canvas). Closing the tab discards them.
          </li>
          <li>
        ...
        <ul className="mt-4 list-disc space-y-2 pl-5 text-pretty text-muted">
          ...
          <li>We do not require an account to compress files.</li>
