...
const APP_NAME = "Free Image Compressor — Compress JPG PNG WebP Online, No Upload | Crush";
...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:image", content: "https://crush-local.vercel.app/og.jpg" },
      { name: "robots", content: "index, follow, max-image-preview:large" },
      { name: "google-adsense-account", content: "ca-pub-7636435144500691" },
      { name: "keywords", content: "free image compressor, compress jpg online free, compress png, compress webp, batch image compressor, no upload, reduce image size" },
    ],
    links: [
