const STEPS = [
  "Drop or choose photos. They stay in this tab.",
  "Pick JPG, PNG or WebP, set quality, optionally cap width or height.",
  "Tap Compress — the browser does the work. Nothing is uploaded.",
